  ...
  function testAPI() {
    ...
    FB.api('/me/friends', function(response) {
        ...
        response.data.forEach(function(ele,i){
        	...
        	$("#table").append("<tr><td>"+i+"</td><td id='tname' >"+response.data[i].name+"</td><td onClick='tdclick(event);'>"+response.data[i].id+"</td></tr>");
   ...
   /* function friends(async){
    ...
    function tdclick(event){
		...
		$('[name="frndId"]').val($(event.target).text());
		$('#friendsProfile').submit();
...
<form id="friendsProfile" method="post" action="friendsProfile">
 <input type="hidden" id="frndId" name="frndId" />
<input type="hidden" id="frndName" name="frndName"/>
